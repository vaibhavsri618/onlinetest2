...
$sql5 = "SELECT qid from addagn WHERE category='" . $category . "'";
$result5 = $conn->query($sql5);
$countques = $result5->num_rows;

$sql = "SELECT qid from addagn WHERE category='" . $category . "' LIMIT {$offset},{$limit}";
            ...
            while ($row2 = $result2->fetch_assoc()) {
                ...
                if ($result3->num_rows > 0) {
                    ...
                    while ($row3 = $result3->fetch_assoc()) {
                        ...
                        echo "<p style='margin-left:40px'><input type='radio' id='radio' name='radio[" . $row3['qid'] . "]' value=" . $row3["aid"] . ">" . $row3["answer"] . "</p>";
                       
                    }
                    
                    if ($offset < ($countques-1)) {
                        echo "<a href='pagination.php?offset=" . ($offset + 1) . "' id='a' name='submit'>Next</a></button2>";
